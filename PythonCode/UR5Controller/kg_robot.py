...
import UR5Controller.kg_robot_dashboard as kgrd
import UR5Controller.waypoints as wp
import UR5Controller.teach_mode as tm
...
class kg_robot():
    ...
    def translatel(self, pose, acc=0.5, vel=0.1, min_time=0, radius=0, wait=True):
        """
